namespace mountain {
    ...
    drawBackground();
    drawSun();
    let mountain: CanvasRenderingContext2D = <CanvasRenderingContext2D>canvas.getContext("2d"); 
    ...
    function drawMountain(_position: Vector, _min: number, _max: number, _light: string, _dark: string): void {
...
/*         mountain.lineCap = "round"; */
        ...
        let grad: CanvasGradient = mountain.createLinearGradient(0,  -_max, 0, 0);
